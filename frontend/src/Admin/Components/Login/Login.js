  ...
  const handle_Submit = async (e) => {
    ...
    await axios.post(`${API_URL}/admin_verify`, data).then((res) => {
      if (res.data) {
        ...
        Cookies.set("area", res.data.area);
        Cookies.set("city", res.data.city);
        Cookies.set("state", res.data.state);
        Cookies.set("admin_name", res.data.name);
        Cookies.set("admin_username", res.data.username);
          ...
          <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
            ...
            <input type="password" id="form1Example23" class="form-control form-control-lg" required name='password' onChange={(e)=>handle_Change(e)}/>
              ...
              <div class="d-flex justify-start-around align-items-center mb-4">
                  ...
                  <Link to="/forget_password" className="btn forget_pass_btn" >
                Forget Password ???
              </Link>
